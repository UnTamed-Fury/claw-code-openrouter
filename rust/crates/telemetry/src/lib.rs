...
pub const DEFAULT_AGENTIC_BETA: &str = "claw-code-20250219";
...
mod tests {
    ...
    fn request_profile_emits_headers_and_merges_body() {
        let profile = AnthropicRequestProfile::new(
            ClientIdentity::new("claw-code", "1.2.3").with_runtime("rust-cli"),
        )
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("user-agent".to_string(), "claw-code/1.2.3".to_string()),
                (
                    "anthropic-beta".to_string(),
                    "claw-code-20250219,prompt-caching-scope-2026-01-05,tools-2026-04-01"
                        .to_string(),
                ),
            ]
        );
